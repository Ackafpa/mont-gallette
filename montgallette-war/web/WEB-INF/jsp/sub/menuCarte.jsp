        ...
        <c:forEach items="${produits}" var="p" varStatus="theCount">
            <tr id="${p.id}">
                <td id="tdStyle${theCount.index%2}"><img id="photoProduit" src=${p.photoURL}>
                    ...
                    <!-- Merci de ne pas effacer mes ajouts-->
                    <a href="Controller?section=commande.acka&action=ajouterLigne&produit=${p.id}"> <div onclick="refreshCommande(${p.id})"  title="Ajouter" id="ajouter"><img src="images/ajouter.png" onmouseover="this.src = 'images/ajouterACTIF.png';" onmouseout="this.src = 'images/ajouter.png';"/></div></a>                  
